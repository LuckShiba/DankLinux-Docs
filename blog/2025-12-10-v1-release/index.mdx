---
title: DMS 1.0 "The Dark Night" Released
...
DMS is now available through the [DankLinux Repository](/docs/danklinux) with official packages for Ubuntu, Debian, OpenSUSE, and Fedora via PPA, OBS, and COPR. Arch Linux users can grab it from the Arch User Repository (AUR).

...
- **[Flake Installation (home-manager)](nixos-flake)** - Recommended for most users, provides per-user installation with home-manager
- **[NixOS Module](nixos)** - System-wide installation using native nixpkgs (when available)

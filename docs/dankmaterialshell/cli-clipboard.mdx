...
description: Wayland clipboard manager with history, search, and persistence
---
...
- `--disable-persist` / `--enable-persist`: Disable/enable clipboard ownership persistence

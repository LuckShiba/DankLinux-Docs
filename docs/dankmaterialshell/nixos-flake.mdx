...
### Config includes with niri-flake (unstable)

Latest git version has a hack for config includes support under the `programs.dank-material-shell.niri.includes` option set.

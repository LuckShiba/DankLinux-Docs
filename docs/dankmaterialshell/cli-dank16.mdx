...
```json
{
  "color0": {"hex": "#1a1a1a", "hex_stripped": "1a1a1a", "r": 26, "g": 26, "b": 26},
  "color1": {"hex": "#e25743", "hex_stripped": "e25743", "r": 226, "g": 87, "b": 67},
  "color2": {"hex": "#6ed677", "hex_stripped": "6ed677", "r": 110, "g": 214, "b": 119},
  ...
}
```

Each color includes the hex value (with and without `#`), plus individual RGB components. This format is also what gets injected into matugen templates as the `dank16` object.
